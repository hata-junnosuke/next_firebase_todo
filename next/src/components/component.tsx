 ...
 * @see https://v0.dev/t/JfY3gEzM5ZG
 */
    ...
    <div className="flex items-center min-h-screen px-4 bg-gradient-to-br from-[#F472B6] to-[#F9A8D4]">
      <div className="w-full max-w-md mx-auto space-y-4 bg-white dark:bg-gray-900 p-6 rounded-lg shadow-lg">
        ...
        <form className="space-y-4">
          ...
          <Button
            className="w-full border border-gray-200 border-pink-600 text-pink-600 dark:border-pink-400 dark:text-pink-400 dark:border-gray-800"
            variant="outline"
          >
            Googleでログイン
          </Button>
